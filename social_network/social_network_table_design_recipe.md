...
1. Name of the first table (always plural): `user accounts` 
...
```
Can one user account have many posts? YES
Can one post have many user accounts? NO

posts have the foreign key (user_account_id)
